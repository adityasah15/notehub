  ...
  return (
    <div className="container mx-auto px-4 py-8 min-h-screen bg-gray-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {notes.map((note) => (
          <div key={note._id} className="p-4 bg-gray-800  rounded-lg shadow-md">
            ...
            <div className="flex space-x-2">
              <button
                ...
                className="bg-yellow-600 rounded-md px-4 mx-1 text-white hover:bg-yellow-700"
              >
                Edit
              </button>
              <button
                onClick={() => handleDelete(note._id)}
                className="bg-red-600 rounded-md px-3 mx-1 text-white hover:bg-red-700"
              >
                Delete
              </button>
            </div>
